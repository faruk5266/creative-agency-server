...
var serviceAccount = require("./service-account/creative-agency-b038d-a6b9033c8a09.json");
const { default: firebaseConfig } = require('./firebase.config');

admin.initializeApp({
  credential: admin.credential.cert(serviceAccount),
  databaseURL: "https://creative-agency-b038d.firebaseio.com"
});



const MongoClient = require('mongodb').MongoClient;
const uri = `mongodb+srv://${process.env.DB_NAME}:${process.env.DB_PASS}@cluster0.fjsvr.mongodb.net/${process.env.MY_DB}?retryWrites=true&w=majority`;
